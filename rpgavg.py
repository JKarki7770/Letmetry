...
while True: 
    ...
    if rthing in ITEMS and rthing not in myitems: 
        ...
        if playerResponse.lower() != "n":
            if rthing==CREATURES[0]: #used 0 so if it is monster the user gets 10 points.
                print (f'You defeated the {rthing} and gained a score of 10.')
                score+=10
            elif rthing!=CREATURES[0]:
                print (f'You defeated the {rthing} and gained a score of 1.')
            score+=1
        if score>100:
